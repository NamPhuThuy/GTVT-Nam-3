...
namespace GUI
{
    ...
    {
        //"Data Source=DESKTOP-OE5VPO5\\SQLEXPRESS;Initial Catalog=LapTrinhTrucQuanDatabase;Integrated Security=True"


        static public string _connectionString = "Data Source=DESKTOP-OE5VPO5\\SQLEXPRESS;Initial Catalog=QLChoThueNha_BTL;User ID=sa;Password=nam123";
